...
class BalancedReplayBuffer(EnvReplayBuffer):
	...
	def random_batch(self, batch_size):
		...
		true_indices = np.random.choice(self.true_indices, size=true_batch_size, replace=self._replace or self.true_indices < true_batch_size)
		false_batch_size = int(self.false_prop*batch_size)
		false_indices = np.random.choice(self.false_indices, size=false_batch_size, replace=self._replace or self.false_indices < false_batch_size)
