...
from rl.policies import CalibrationPolicy, NPEncDecPolicy
from rl.path_collectors import FullPathCollector
from rl.misc.env_wrapper import default_overhead
from rl.trainers import NPLatentEncDecSACTrainer
from rl.replay_buffers import ModdedTrajReplayBuffer
...
def experiment(variant):
    ...
    trainer = NPLatentEncDecSACTrainer(
        vaes=vaes,
        prev_vae=prev_vae,
        policy=policy,
        qf1=qf1,
    ...
    if variant['keep_calibration_data']:
        ...
        calibration_buffer = ModdedTrajReplayBuffer(
            variant['replay_buffer_size'],
            env,
            sample_base=0,
            latent_size=variant['latent_size'],
