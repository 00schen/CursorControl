...
from rl.policies import BoltzmannPolicy, OverridePolicy, ComparisonMergePolicy, RecurArgmaxPolicy
...
from rl.trainers import RecurBCTrainer
from rl.misc.full_traj_replay_buffer import FullTrajReplayBuffer
from rl.scripts.run_util import run_exp
from rl.misc.utils import make_alpha_relu
from rl.misc.recurrent import Recurrent
...
def experiment(variant):
	...
	trainer = RecurBCTrainer(
		policy=qf1,
		**variant['trainer_kwargs']
	)
	replay_buffer = FullTrajReplayBuffer(
