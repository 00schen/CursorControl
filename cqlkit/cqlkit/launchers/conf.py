...
cqlkit_project_dir = join(os.path.dirname(cqlkit.__file__), os.pardir)
LOCAL_LOG_DIR = join(cqlkit_project_dir, 'data')
...
RUN_DOODAD_EXPERIMENT_SCRIPT_PATH = (
    join(cqlkit_project_dir, 'scripts', 'run_experiment_from_doodad.py')
    # '/home/user/path/to/cqlkit/scripts/run_experiment_from_doodad.py'
)
"""
AWS Settings
"""
...
SSS_RUN_DOODAD_EXPERIMENT_SCRIPT_PATH = (
    '/global/home/users/USERNAME/path/to/cqlkit/scripts'
...
try:
    from cqlkit.launchers.conf_private import *
except ImportError:
