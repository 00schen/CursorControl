...
from cqlkit.launchers import conf
from cqlkit.torch.pytorch_util import set_gpu_mode
import cqlkit.pythonplusplus as ppp
...
def run_experiment(
    ...
    :param use_gpu:
    :param snapshot_mode: See cqlkit.core.logging
    :param snapshot_gap: See cqlkit.core.logging
    ...
    if mode == 'local':
        ...
        dmode = doodad.mode.EC2AutoconfigDocker(
            ...
            # will start just making the sub-directories within cqlkit rather
