...
class RewardTrainer(TorchTrainer):
	...
	def train_from_torch(self, batch):
		...
		"""
		if self.use_mixup:
			(train_obs,train_actions,train_next_obs),train_rewards = mixup([obs,actions,next_obs],rewards)
		else:
			train_obs,train_actions,train_next_obs,train_rewards = obs,actions,next_obs,rewards
		rf_pred = self.rf(train_obs,train_actions,train_next_obs)
		...
		"""
		self.rf.train(False)
		stat_pred = self.rf(obs,actions,next_obs).detach()
